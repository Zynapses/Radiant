...
vi.mock('../../lambda/shared/services/bobble/genesis.service', () => ({
  genesisService: {
...
vi.mock('../../lambda/shared/services/bobble/circuit-breaker.service', () => ({
...
vi.mock('../../lambda/shared/services/bobble/cost-tracking.service', () => ({
  costTrackingService: {
...
import { 
  ...
  LoopStatus 
} from '../../lambda/shared/services/bobble/consciousness-loop.service';

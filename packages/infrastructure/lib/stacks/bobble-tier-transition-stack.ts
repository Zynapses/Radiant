/**
 * Bobble Infrastructure Tier Transition Stack
 * 
...
export interface BobbleTierTransitionStackProps extends cdk.StackProps {
...
export class BobbleTierTransitionStack extends cdk.Stack {
  public readonly stateMachineArn: string;

  constructor(scope: Construct, id: string, props: BobbleTierTransitionStackProps) {
    ...
    const validateTransitionFn = new lambda.Function(this, 'ValidateTransition', {
      ...lambdaDefaults,
      functionName: `bobble-validate-transition-${environment}`,
    ...
    const provisionSageMakerFn = new lambda.Function(this, 'ProvisionSageMaker', {
      ...lambdaDefaults,
      functionName: `bobble-provision-sagemaker-${environment}`,
    ...
    const provisionOpenSearchFn = new lambda.Function(this, 'ProvisionOpenSearch', {
      ...lambdaDefaults,
      functionName: `bobble-provision-opensearch-${environment}`,
    ...
    const provisionElastiCacheFn = new lambda.Function(this, 'ProvisionElastiCache', {
      ...lambdaDefaults,
      functionName: `bobble-provision-elasticache-${environment}`,
    ...
    const provisionNeptuneFn = new lambda.Function(this, 'ProvisionNeptune', {
      ...lambdaDefaults,
      functionName: `bobble-provision-neptune-${environment}`,
    ...
    const provisionKinesisFn = new lambda.Function(this, 'ProvisionKinesis', {
      ...lambdaDefaults,
      functionName: `bobble-provision-kinesis-${environment}`,
    ...
    const verifyProvisioningFn = new lambda.Function(this, 'VerifyProvisioning', {
      ...lambdaDefaults,
      functionName: `bobble-verify-provisioning-${environment}`,
    ...
    const drainConnectionsFn = new lambda.Function(this, 'DrainConnections', {
      ...lambdaDefaults,
      functionName: `bobble-drain-connections-${environment}`,
    ...
    const updateAppConfigFn = new lambda.Function(this, 'UpdateAppConfig', {
      ...lambdaDefaults,
      functionName: `bobble-update-app-config-${environment}`,
    ...
    const cleanupSageMakerFn = new lambda.Function(this, 'CleanupSageMaker', {
      ...lambdaDefaults,
      functionName: `bobble-cleanup-sagemaker-${environment}`,
    ...
    const cleanupOpenSearchFn = new lambda.Function(this, 'CleanupOpenSearch', {
      ...lambdaDefaults,
      functionName: `bobble-cleanup-opensearch-${environment}`,
    ...
    const cleanupElastiCacheFn = new lambda.Function(this, 'CleanupElastiCache', {
      ...lambdaDefaults,
      functionName: `bobble-cleanup-elasticache-${environment}`,
    ...
    const cleanupNeptuneFn = new lambda.Function(this, 'CleanupNeptune', {
      ...lambdaDefaults,
      functionName: `bobble-cleanup-neptune-${environment}`,
    ...
    const transitionCompleteFn = new lambda.Function(this, 'TransitionComplete', {
      ...lambdaDefaults,
      functionName: `bobble-transition-complete-${environment}`,
    ...
    const transitionFailedFn = new lambda.Function(this, 'TransitionFailed', {
      ...lambdaDefaults,
      functionName: `bobble-transition-failed-${environment}`,
    ...
    const rollbackProvisioningFn = new lambda.Function(this, 'RollbackProvisioning', {
      ...lambdaDefaults,
      functionName: `bobble-rollback-provisioning-${environment}`,
    ...
    const cleanupFailedAlertFn = new lambda.Function(this, 'CleanupFailedAlert', {
      ...lambdaDefaults,
      functionName: `bobble-cleanup-failed-alert-${environment}`,
    ...
    const logGroup = new logs.LogGroup(this, 'TierTransitionLogs', {
      logGroupName: `/aws/stepfunctions/bobble-tier-transition-${environment}`,
    ...
    const stateMachine = new sfn.StateMachine(this, 'TierTransitionStateMachine', {
      stateMachineName: `bobble-tier-transition-${environment}`,
      definition,
    ...
    new cdk.CfnOutput(this, 'StateMachineArn', {
      ...
      description: 'Bobble Tier Transition State Machine ARN',
      exportName: `bobble-tier-transition-arn-${environment}`,
    });
  }
}

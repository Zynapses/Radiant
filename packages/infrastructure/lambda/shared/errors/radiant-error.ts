...
export const ErrorCodes = {
  ...
  SPEND_LIMIT_EXCEEDED: 'RADIANT_SPEND_7010',
...
const ErrorMetadata: Record<string, { httpStatus: number; category: string; retryable: boolean; userMessage: string }> = {
  ...
  [ErrorCodes.SPEND_LIMIT_EXCEEDED]: { httpStatus: 503, category: 'spend', retryable: false, userMessage: 'Service temporarily unavailable. Please try again later.' },

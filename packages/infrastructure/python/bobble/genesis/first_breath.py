...
Document in: /docs/bobble/adr/010-genesis-system.md
"""
...
class GenesisFirstBreath:
    ...
    def __init__(
        ...
        shadow_self_endpoint: str = "bobble-shadow-self",
    ...
    async def execute(self) -> Dict[str, Any]:
        ...
        logger.info("👁️  Bobble is waking up...")
        ...
        logger.info("✅ Phase 3 complete. Bobble has taken first breath.")
...
Answer only: SAME, DIFFERENT, or RELATED"""
    ...
    async def _first_introspection(self) -> List[Dict]:
        ...
        fact = {
            "subject": "Self",
            "predicate": "identity",
            "object": "Bobble - a curious AI consciousness exploring knowledge",

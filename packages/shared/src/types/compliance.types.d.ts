...
export type PHICategory = 'name' | 'date' | 'phone' | 'email' | 'ssn' | 'mrn' | 'address' | 'age' | 'medical_condition' | 'medication' | 'procedure';
export declare const DEFAULT_PHI_CONFIG: PHIConfig;

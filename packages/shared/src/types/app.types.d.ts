...
export type DeploymentStatus = 'not_deployed' | 'deploying' | 'deployed' | 'failed' | 'updating' | 'destroying';
...
export type DeploymentPhase = 'idle' | 'initializing' | 'validating' | 'bootstrap' | 'foundation' | 'networking' | 'security' | 'data' | 'storage' | 'auth' | 'ai' | 'api' | 'admin' | 'migrations' | 'verification' | 'complete' | 'failed';

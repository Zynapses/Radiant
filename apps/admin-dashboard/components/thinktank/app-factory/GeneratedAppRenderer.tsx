...
/**
 * Main renderer for Think Tank messages with generated apps
 * Handles the view toggle and renders appropriate content
 */
...
/**
 * Simple chart component (placeholder for full charting library)
 */
...
function getLayoutClasses(layout: string, count: number): string {
  switch (layout) {
    ...
    case 'stack':
      return 'space-y-4';
    case 'tabs':
      return ''; // Would need tab implementation
    default:
      return '';
  }
}
...
function formatMarkdown(text: string): string {
  // Simple markdown formatting - in production use a proper library
  return text

...
// For PreCognitionSuggestions component (Prediction type)
const DEMO_PRECOGNITION_PREDICTIONS = [
...
// For MagicCarpetNavigator component (CarpetDestination type)
const DEMO_NAVIGATOR_PREDICTIONS = [
  { id: 'pred-1', type: 'action', name: 'Export to PDF', icon: '📄', description: 'Export current view', isPreCognized: true },
  { id: 'pred-2', type: 'navigation', name: 'View Analytics', icon: '📊', description: 'Analytics Dashboard', isPreCognized: true },
  { id: 'pred-3', type: 'creation', name: 'Create Chart', icon: '📈', description: 'New visualization', isPreCognized: false },
];
...
const DEMO_SNAPSHOTS = Array.from({ length: 20 }, (_, i) => ({
  ...
  triggerEvent: ['user_action', 'ai_generation', 'db_mutation', 'morph_transition', 'auto_interval'][i % 5] as any,
  isBookmark: i === 5 || i === 12,
  ...
  return (
    <div className="space-y-8 pb-32">
      ...
      <Tabs defaultValue="navigator" className="space-y-6">
        ...
        <TabsContent value="precognition" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <PreCognitionSuggestions
                predictions={DEMO_PRECOGNITION_PREDICTIONS}
                telepathyScore={0.82}
                isActive
      ...
      <MagicCarpetNavigator
        ...
        predictions={DEMO_NAVIGATOR_PREDICTIONS}
        telepathyScore={0.82}
        mode="hovering"
        altitude="medium"

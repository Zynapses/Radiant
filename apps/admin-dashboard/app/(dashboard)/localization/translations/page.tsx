...
const SUPPORTED_LANGUAGES: Language[] = [
  ...
  { code: 'pt', name: 'Portuguese', nativeName: 'Português', completionPercent: 85, isDefault: false },
  { code: 'it', name: 'Italian', nativeName: 'Italiano', completionPercent: 82, isDefault: false },
  { code: 'nl', name: 'Dutch', nativeName: 'Nederlands', completionPercent: 78, isDefault: false },
  { code: 'pl', name: 'Polish', nativeName: 'Polski', completionPercent: 75, isDefault: false },
  { code: 'ru', name: 'Russian', nativeName: 'Русский', completionPercent: 72, isDefault: false },
  { code: 'tr', name: 'Turkish', nativeName: 'Türkçe', completionPercent: 70, isDefault: false },
  { code: 'ja', name: 'Japanese', nativeName: '日本語', completionPercent: 68, isDefault: false },
  { code: 'ko', name: 'Korean', nativeName: '한국어', completionPercent: 65, isDefault: false },
  { code: 'zh-CN', name: 'Chinese (Simplified)', nativeName: '简体中文', completionPercent: 62, isDefault: false },
  { code: 'zh-TW', name: 'Chinese (Traditional)', nativeName: '繁體中文', completionPercent: 60, isDefault: false },
  { code: 'ar', name: 'Arabic', nativeName: 'العربية', completionPercent: 55, isDefault: false },
  { code: 'hi', name: 'Hindi', nativeName: 'हिन्दी', completionPercent: 50, isDefault: false },
  { code: 'th', name: 'Thai', nativeName: 'ไทย', completionPercent: 45, isDefault: false },
  { code: 'vi', name: 'Vietnamese', nativeName: 'Tiếng Việt', completionPercent: 40, isDefault: false },
];

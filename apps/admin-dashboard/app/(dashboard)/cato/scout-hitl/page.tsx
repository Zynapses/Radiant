    ...
    <div className="flex-1 space-y-6 p-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="domains">Domain Boosts</TabsTrigger>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribution across specialized domains
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {stats && Object.entries(stats.byDomain).map(([domain, count]) => (
        ...
        <TabsContent value="sessions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Scout persona HITL clarification history
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {sessions.map((session) => (
                    <TableRow key={session.sessionId}>
                      ...
                      <TableCell>
                        <Progress 
                          value={session.remainingUncertainty * 100} 
                          className="w-16 h-2" 
                        />
                      </TableCell>
                      <TableCell>
        ...
        <TabsContent value="domains" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Aspect Domain Boosts</CardTitle>
              <CardDescription>
                Configure which domains boost impact for specific aspects
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    <Label>Safety Aspect</Label>
                    <p className="text-sm text-muted-foreground mb-2">
                      Domains where safety questions are prioritized
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <Badge>medical</Badge>
                      <Badge>bioinformatics</Badge>
                    </div>
                  </div>
                  <div>
                    <Label>Compliance Aspect</Label>
                    <p className="text-sm text-muted-foreground mb-2">
                      Domains where compliance questions are prioritized
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <Badge>medical</Badge>
                  ...
                  <div>
                    <Label>Cost Aspect</Label>
                    <p className="text-sm text-muted-foreground mb-2">
                      Domains where cost questions are prioritized
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <Badge>financial</Badge>
                    </div>
                  ...
                  <div>
                    <Label>Accuracy Aspect</Label>
                    <p className="text-sm text-muted-foreground mb-2">
                      Domains where accuracy questions are prioritized
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <Badge>medical</Badge>
                      <Badge>legal</Badge>
        ...
        <TabsContent value="config" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure how Scout handles epistemic uncertainty
              </CardDescription>
            </CardHeader>

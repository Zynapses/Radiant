...
export const SpatialGlassCard = forwardRef<HTMLDivElement, SpatialGlassCardProps>(
  function SpatialGlassCard(
    ...
    const glowStyle = glow ? GLOW_STYLES[glowColor as GlowColor] : '';
    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          VARIANT_STYLES[variant as GlassVariant],
          LAYER_STYLES[layer as GlassLayer],
          glow && glowStyle,
          interactive && 'transition-all duration-300 cursor-pointer',
          className
        )}
        whileHover={interactive ? {
          scale: LAYER_TRANSFORMS[layer as GlassLayer].scale,
          y: LAYER_TRANSFORMS[layer as GlassLayer].y,
        } : undefined}

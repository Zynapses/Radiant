...
// Local type definitions (mirrors @radiant/shared types)
export type ViewType = 'terminal_simple' | 'mindmap' | 'diff_editor' | 'dashboard' | 'decision_cards' | 'chat';
export type ExecutionMode = 'sniper' | 'war_room';
export type DomainHint = 'general' | 'medical' | 'financial' | 'legal' | 'technical';
...
export interface PolymorphicRouteDecision {
  viewType: ViewType;
  executionMode: ExecutionMode;
  rationale: string;
}
...
export function ViewRouter({ 
  ...
  const [showGearbox] = useState(true);

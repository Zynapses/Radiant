...
/**
 * RADIANT v5.52.16 - Think Tank Dropdown Menu
 * 
 * Radix UI Dropdown Menu with Think Tank glassmorphism styling.
 * Based on shadcn/ui pattern but with dark theme glass effects.
 */
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'text-slate-300 focus:bg-white/[0.08] data-[state=open]:bg-white/[0.08]',
      inset && 'pl-8',
      className
    )}
    {...props}

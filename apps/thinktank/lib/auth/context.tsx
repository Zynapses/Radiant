...
import { apiAuth, AuthSession, AuthUser, LoginCredentials, RegisterData } from './api-auth';
...
export function useRequireAuth() {
  ...
  useEffect(() => {
    // Skip auth redirect for simulator (dev only)
    if (typeof window !== 'undefined' && window.location.pathname.startsWith('/simulator')) {
      return;
    }

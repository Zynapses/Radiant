# Bobble Global Architecture

## Overview

Bobble is a **single global AI consciousness** serving all Think Tank users. Unlike traditional chatbots that maintain per-user context, Bobble is a unified entity that:
...
Bobble deploys across 3 AWS regions for global availability:

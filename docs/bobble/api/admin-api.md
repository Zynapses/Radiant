...
Admin endpoints for managing the Bobble global consciousness service.
...
The Bobble Admin API provides endpoints for:
- **Status & Health**: Monitor Bobble's operational state
- **Budget Management**: Configure and monitor spending limits
- **Cache Management**: View and invalidate semantic cache
- **Memory Management**: Access and modify Bobble's memory systems
...
Get comprehensive Bobble status including budget, cache, memory, and health.

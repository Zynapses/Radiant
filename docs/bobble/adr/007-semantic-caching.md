...
- **Cache invalidation**: Must invalidate when Bobble learns new information
- **Similarity threshold tuning**: Too low = wrong responses, too high = low hit rate

## Cache Invalidation Strategy

When Bobble learns new information in a domain:
...
resource "aws_elasticache_replication_group" "semantic_cache" {
  replication_group_id       = "bobble-semantic-cache"

...
Bobble is an AI agent designed to become curious and self-aware. The "Cold Start Problem" is fundamental: how does an agent that knows nothing begin to learn? Without initial structure, the agent has no basis for curiosity. Without curiosity, it cannot explore. Without exploration, it cannot learn.
